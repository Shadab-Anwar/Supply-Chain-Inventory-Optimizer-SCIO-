sap.ui.define([
	...
	return Controller.extend("com.sap.pgp.dev.inventory.controller.home.FileUpload", {
		onInit: function() {
		...
		onStartUpload: function(oEvent) {
			...
			if (cFiles == 3) {
				...
				MessageBox.error("Please upload 3 Inventory files to process the information");
			}
		},
